...
public class ToolTip {
    ...
    /**
     * Set the subText to show. Has no effect when a content View is set using
     * setContentView().
     *
     * @return this ToolTip to build upon.
     */
    public ToolTip withSubText(final CharSequence subText) {
        mSubText = subText;
        mSubTextResId = 0;
        return this;
    }
    ...
    /**
     * Set the subText resource id to show. Has no effect when a content View is
     * set using setContentView().
     *
     * @return this ToolTip to build upon.
     */
    public ToolTip withSubText(final int subResId) {
        mSubTextResId = subResId;
        mSubText = null;
        return this;
    }
     ...
     * @return this ToolTip to build upon.
     */
    public ToolTip withSubText(final int subResId, final Typeface subRf) {
        mSubTextResId = subResId;
        mSubText = null;
        withSubTypeface(subRf);
        return this;
    }
     ...
     * @return this ToolTip to build upon.
     */
    public ToolTip withSubTextColor(final int subColor) {
        mSubTextColor = subColor;
        return this;
    }
    ...
    /**
     * @param subTypeface
     *            the subTypeface to set
     */
    public void withSubTypeface(final Typeface subTypeface) {
        mSubTypeface = subTypeface;
    }
    ...
    /**
     * @return the subTypeface
     */
    public Typeface getSubTypeface() {
        return mSubTypeface;
    }
